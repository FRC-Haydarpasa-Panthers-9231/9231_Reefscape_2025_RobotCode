...
public class ElevatorConstants {
  ...
  public static final AngularVelocity kManualZeroingStartVelocity = Units.RotationsPerSecond.of(5);
  public static final AngularVelocity kManualZeroingDeltaVelocity = Units.RotationsPerSecond.of(5);
