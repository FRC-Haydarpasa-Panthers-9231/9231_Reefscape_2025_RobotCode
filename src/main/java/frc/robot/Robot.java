...
public class Robot extends LoggedRobot {
    ...
    public void robotPeriodic()
    {
        ...
        /**
         * devre dışı kalma zamanlayıcısını sıfırla. Bu, pil düşük olsa bile robotun etkin modda
         * oldugu
    ...
    public void autonomousInit()
    {
        ...
        /**
         * Otonom dashboard'ı ilk dashboard oldugu için otonom başladıgında otomatik olarak
         * dashboard'ı
         * ayarlar.
         */
        if (!Constants.debug && Constants.kIsCompetition && !Constants.tuningMode) {
