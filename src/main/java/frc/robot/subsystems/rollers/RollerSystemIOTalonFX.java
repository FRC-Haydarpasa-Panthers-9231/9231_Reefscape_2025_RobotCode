...
public class RollerSystemIOTalonFX implements RollerSystemIO {
  ...
  public RollerSystemIOTalonFX(
    ...
    talon = new TalonFX(deviceId, bus);
    configAlert =
        new Alert(
    ...
    Phoenix6Util.applyAndCheckConfiguration(talon, config, configAlert);
    ...
    Phoenix6Util.tryUntilOk(
        ...
        () ->
            BaseStatusSignal.setUpdateFrequencyForAll(
                ...
                tempCelsius,
                tempFault));
    Phoenix6Util.tryUntilOk(5, () -> talon.optimizeBusUtilization(0, 1.0));

    FaultReporter.getInstance()
        .registerHardware(subsystemName, String.format("Roller Motor %d", deviceId), talon);
  ...
  public void setCurrentLimit(double currentLimit) {
    new Thread(
        () -> {
          ...
          Phoenix6Util.tryUntilOk(5, () -> talon.getConfigurator().apply(config));
        });
  }
