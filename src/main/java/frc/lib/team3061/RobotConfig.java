...
import frc.lib.team3061.RobotConfig.LED_HARDWARE;
...
public abstract class RobotConfig {
  ...
  public Translation2d getFrontRightCornerPosition() {
    return new Translation2d(0.36, 0.36);
  }
  ...
  public com.pathplanner.lib.config.RobotConfig getPathPlannerRobotConfig() {
    return new com.pathplanner.lib.config.RobotConfig(
        ...
        new ModuleConfig(
            ...
            getRobotMaxVelocity(),
            getWheelCOF(),
            DCMotor.getKrakenX60Foc(1).withReduction(getSwerveConstants().getDriveGearRatio()),
  ...
  /**
   * Returns the driver controller port. Defaults to 0.
   *
   * @return driver controller port
   */
  ...
  /**
   * Returns the operator controller port. Defaults to 1.
   *
   * @return operator controller port
   */
  public int getOperatorControllerPort() {
    return 1;
  }
  /**
   * Returns the debug controller port. Defaults to 2.
   *
   * @return debug controller port
   */
  public int getDebugControllerPort() {
    return 2;
  }
  /**
   * Returns the debug controller port 2. Defaults to 3.
   *
   * @return debug controller port 2
   */
