...
public class SUB_Elevator extends SubsystemBase {
    ...
    private static boolean hasZeroeda = true;
    ...
    public void periodic()
    {
        ...
        if (limitSwitchvalue() == true && io.getElevatorPosition() <= 1 && hasZeroeda == false) {
        ...
        } else if (hasZeroeda == true && io.getElevatorPosition() > 1
            && limitSwitchvalue() == false) {
            hasZeroeda = false;
            enSon = "ikinci";
        }

        Logger.recordOutput("Elevator/En son giren", enSon);
        Logger.recordOutput("Elevator/HasZeroeada", hasZeroeda);
        Logger.processInputs("Elevator", inputs);
        Logger.recordOutput("Elevator/ElevatorPosition", io.getElevatorPosition());
    ...
    {
        double volts =
            isForward ? elevatorDebugVolts.getAsDouble() * 1
                : elevatorDebugVolts.getAsDouble() * -1;
