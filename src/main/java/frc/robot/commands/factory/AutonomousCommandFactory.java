...
public class AutonomousCommandFactory {
  ...
  private Command getCollectCoralCommand(SUB_ElevatorRoller elevatorRoller) {
    return Commands.waitUntil(()->elevatorRoller.hasCoral());
  }
  ...
  private Command scoringCoral(
      SUB_Elevator elevator, SUB_ElevatorRoller elevatorRoller, ELEVATOR_HEIGHT scoringHeight) {
    return Commands.sequence(
        Commands.runOnce(() -> elevator.setPosition(scoringHeight.getPositionRads()), elevator),
        Commands.waitUntil(() -> elevator.isAtSetPoint()),
        elevatorRoller.scoreCoralwithJustRollers(),
        Commands.runOnce(
            () ->
  ...
  private Command scoringCoralWithDrive(
    ...
    return Commands.sequence(
        Commands.parallel(
            ...
            Commands.waitUntil(() -> elevator.isAtSetPoint())),
        elevatorRoller.scoreCoralwithJustRollers(),
        elevator.setPosition(scoringHeight.getPositionRads()));
  }
}
