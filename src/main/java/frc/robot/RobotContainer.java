...
public class RobotContainer {
  ...
  private void operatorContorllerBindings() {
    ...
    operatorController
        .a()
        .and(isCoralMode)
        .onTrue(new ScoringCoral(elevator, leds, elevatorRoller, ELEVATOR_HEIGHT.CORAL_L1_HEIGHT));
    operatorController
        .b()
        .and(isCoralMode)
        .onTrue(new ScoringCoral(elevator, leds, elevatorRoller, ELEVATOR_HEIGHT.CORAL_L2_HEIGHT));
    operatorController
        .x()
        .and(isCoralMode)
        .onTrue(new ScoringCoral(elevator, leds, elevatorRoller, ELEVATOR_HEIGHT.CORAL_L3_HEIGHT));
    operatorController
        .y()
        .and(isCoralMode)
