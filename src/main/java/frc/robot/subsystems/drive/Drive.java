...
public class Drive extends SubsystemBase {
    ...
    private static final double ROBOT_MASS_KG = 52.088;
    private static final double ROBOT_MOI = 15.883; // 6.8384633334 -Deniz
        ...
        ModuleIO brModuleIO)
    {
        ...
        AutoBuilder.configure(
            ...
            new PPHolonomicDriveController(
                new PIDConstants(5.0, 0.0, 0.0), new PIDConstants(8.0, 0.0, 0.0)),
            PP_CONFIG,
        ...
        SmartDashboard.putData(
            ...
            new Sendable() {
                ...
                public void initSendable(SendableBuilder builder)
                {
                    ...
                    builder.addDoubleProperty(
                        "Front Left Velocity", () -> getModuleStates()[0].speedMetersPerSecond,
                        null);

                    builder.addDoubleProperty(
                        "Front Right Angle", () -> getModuleStates()[1].angle.getRadians(), null);
                    builder.addDoubleProperty(
                        "Front Right Velocity", () -> getModuleStates()[1].speedMetersPerSecond,
                        null);

                    builder.addDoubleProperty(
                        "Back Left Angle", () -> getModuleStates()[2].angle.getRadians(), null);
                    builder.addDoubleProperty(
                        "Back Left Velocity", () -> getModuleStates()[2].speedMetersPerSecond,
                        null);

                    builder.addDoubleProperty(
                        "Back Right Angle", () -> getModuleStates()[3].angle.getRadians(), null);
                    builder.addDoubleProperty(
                        "Back Right Velocity", () -> getModuleStates()[3].speedMetersPerSecond,
                        null);

                    builder.addDoubleProperty("Robot Angle", () -> getRotation().getRadians(),
                        null);
                }
            });
    }
