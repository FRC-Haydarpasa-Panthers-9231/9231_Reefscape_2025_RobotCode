...
public class DefaultRobotConfig extends RobotConfig {
  ...
  private static final int DEBUG_CONTROLLER_PORT = 2;
  private static final int DEBUG_CONTROLLER_PORT_2 = 3;

  // FIXME: update all CAN IDs and steer offsets
  private static final int FRONT_LEFT_MODULE_DRIVE_MOTOR = 2;
  private static final int FRONT_LEFT_MODULE_STEER_MOTOR = 1;
  private static final int FRONT_LEFT_MODULE_STEER_ENCODER = 17;
  private static final Angle FRONT_LEFT_MODULE_STEER_OFFSET = Rotations.of(0.482421875);

  private static final int FRONT_RIGHT_MODULE_DRIVE_MOTOR = 4;
  private static final int FRONT_RIGHT_MODULE_STEER_MOTOR = 3;
  private static final int FRONT_RIGHT_MODULE_STEER_ENCODER = 15;
  private static final Angle FRONT_RIGHT_MODULE_STEER_OFFSET = Rotations.of(0.4716796875);

  private static final int BACK_LEFT_MODULE_DRIVE_MOTOR = 8;
  private static final int BACK_LEFT_MODULE_STEER_MOTOR = 7;
  private static final int BACK_LEFT_MODULE_STEER_ENCODER = 16;
  private static final Angle BACK_LEFT_MODULE_STEER_OFFSET = Rotations.of(-0.47119140625);

  private static final int BACK_RIGHT_MODULE_DRIVE_MOTOR = 6;
  private static final int BACK_RIGHT_MODULE_STEER_MOTOR = 5;
  private static final int BACK_RIGHT_MODULE_STEER_ENCODER = 18;
  private static final Angle BACK_RIGHT_MODULE_STEER_OFFSET = Rotations.of(-0.311767578125);

  private static final int GYRO_ID = 20;

  // FIXME: update robot dimensions
  private static final Mass MASS = Kilograms.of(62);
  private static final MomentOfInertia MOI = KilogramSquareMeters.of(6.0); // FIXME: measure
  private static final Distance TRACKWIDTH = Meters.of(0.545); // TODO:TRACK WIDTH AYARLA
  private static final Distance WHEELBASE = Meters.of(0.545); // TODO: WHEEL BASE AYARLA
  private static final Distance WHEEL_RADIUS = Meters.of(0.051054);
  private static final double WHEEL_COEFFICIENT_OF_FRICTION = 1.190;
  private static final Translation2d FRONT_RIGHT_CORNER_POSITION = new Translation2d(0.36, -0.36);
  private static final Distance ROBOT_WIDTH_WITH_BUMPERS = Meters.of(0.885);
  private static final Distance ROBOT_LENGTH_WITH_BUMPERS = Meters.of(0.885);
  ...
  private static final double ANGLE_KP = 125;
  private static final double ANGLE_KI = 0.0;
  private static final double ANGLE_KD = 1;

  // FIXME: characterize the drivetrain and update these constants
  private static final double ANGLE_KS = 0.2;
  private static final double ANGLE_KV = 1.55; // convert from V/(radians/s) to V/(rotations/s)
  ...
  private static final LinearVelocity MAX_VELOCITY = MetersPerSecond.of(4.6);
  private static final LinearVelocity MAX_COAST_VELOCITY = MetersPerSecond.of(0.05);
  private static final double SLOW_MODE_MULTIPLIER = 0.65;
  ...
  private static final LinearVelocity DRIVE_TO_POSE_MAX_VELOCITY = MetersPerSecond.of(1.5);
  ...
  private static final int CORAL_SENSOR_ID = 4;
  private static final int ELEVATOR_LIMIT_SWITCH_ID = 2;
  ...
  @Override
  public int getCoralSensorID() {
    return CORAL_SENSOR_ID;
  }

  @Override
  public int getElevatorLimitSwitchID() {
    return ELEVATOR_LIMIT_SWITCH_ID;
  }
  ...
  public int getDriverControllerPort() {
    return DRIVER_CONTROLLER_PORT;
  }

  public int getOperatorControllerPort() {
    return OPERATOR_CONTROLLER_PORT;
  }

  public int getDebugControllerPort() {
    return DEBUG_CONTROLLER_PORT;
  }

  public int getDebugControllerPort2() {
    return DEBUG_CONTROLLER_PORT_2;
  }
}
