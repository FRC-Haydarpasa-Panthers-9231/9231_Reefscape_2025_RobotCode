...
public class RobotContainer {
    ...
    private void driverControllerBindings()
    {
         ...
         */
        driverController.x()
            .onTrue(Commands.runOnce(drive::stopWithX, drive).withName("Stop With X"));
    ...
    private void debugControllerBindings()
    {
        ...
        debugController
            .b()
            .onTrue(
                Commands.runOnce(() -> elevator.setPosition(9), elevator)
        ...
        debugController.rightBumper().whileTrue(Commands.run(() -> elevatorRoller.setSpeed(0.5)))
            .onFalse(Commands.runOnce(() -> elevatorRoller.setSpeed(0)));
        ...
        debugController.pov(0).whileTrue(Commands.run(() -> System.out.println("POV 0")));
    ...
    private void registerNamedCommands()
    {
        ...
        NamedCommands.registerCommand(
            "elevatorZeroPose",
            Commands
                .runOnce(() -> elevator.setPosition(ELEVATOR_HEIGHT.ZERO_HEIGHT.getPositionRads()))
